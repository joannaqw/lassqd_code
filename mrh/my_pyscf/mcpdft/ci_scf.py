...
def get_heff_cas (mc, mo_coeff, ci, link_index=None):
    ncore, ncas, _nelec = mc.ncore, mc.ncas, mc.nelecas
    nocc = ncore + ncas
...
def mc1step_casci(mc, mo_coeff, ci0=None, eris=None, verbose=None, envs=None):
    ...
    ncas, nelecas = mc.ncas, mc.nelecas
    mc.fcisolver.gen_linkstr(ncas, nelecas, True)
    mc.fcisolver.gen_linkstr(ncas, nelecas, False)
...
def mc1step_update_casdm(mc, mo, u, fcivec, e_cas, eris, envs={}):
    ...
    mo1 = np.dot (mo, u)
    _ncore, ncas, nelecas = mc.ncore, mc.ncas, mc.nelecas
