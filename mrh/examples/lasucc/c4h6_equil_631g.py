...
try:
    mo_loc = np.load ('c4h6_equil_631g.mo.npy')
    ...
    psi = ucc.fcisolver.load_psi ('c4h6_equil_631g.psi.npy',
        norb, nelec, norb_f)
...
ucc.kernel (mo_loc)
molden.from_mcscf (ucc, 'c4h6_equil_lasuccsd_631g.molden', cas_natorb=True)
e_luc = ucc.e_tot

# Cache result for the next time you run this
np.save ('c4h6_equil_631g.mo', ucc.mo_coeff)
ucc.fcisolver.save_psi ('c4h6_equil_631g.psi', ucc.fcisolver.psi)
