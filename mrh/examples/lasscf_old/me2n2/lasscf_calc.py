...
#       Load active orbitals and 1RDM from a different point on the potential energy curve
#       r_nn_guess is N=N internuclear distance from another LASSCF calculation,
