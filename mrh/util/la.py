...
def matrix_svd_control_options (the_matrix, full_matrices=False, only_nonzero_vals=False, sort_vecs=-1,
    ...
    return_llabels = lsymm is not None or symmetry is not None or lspace_symmetry is not None
    return_rlabels = rsymm is not None or symmetry is not None or rspace_symmetry is not None
    False if lspace_symmetry is None else isinstance (rspace_symmetry[0], np.ndarray)
    False if rspace_symmetry is None else isinstance (rspace_symmetry[0], np.ndarray)
...
def matrix_eigen_control_options (the_matrix, b_matrix=None, symmetry=None, strong_symm=False, 
    ...
    return_labels = symmetry is not None or subspace_symmetry is not None
