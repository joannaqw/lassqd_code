    ...
    def test_nac_h2_sa2casscf22_sto3g(self):
        ...
        for i in range(2):
            with self.subTest(use_etfs=bool(i)):
                ...
                de_err = de - de_ref[i]
                print ("test_nac_h2_sa2casscf22_sto3g:", de_err, de_ref[i])
    ...
    def test_nac_h2_sa3casscf22_sto3g(self):
        ...
        for i in range(2):
            with self.subTest(use_etfs=bool(i)):
                ...
                self.assertAlmostEqual(de[1], de_ref[i, 1], 5)
                de_err = de - de_ref[i]
                print ("test_nac_h2_sa3casscf22_sto3g:", de_err, de_ref[i])
    ...
    def test_nac_h2_sa2caasf22_631g(self):
        ...
        for i in range(2):
            with self.subTest(use_etfs=bool(i)):
                ...
                self.assertAlmostEqual(de[1], de_ref[i, 1], 5)
                de_err = de - de_ref[i]
                print ("test_nac_h2_sa2casscf22_631g:", de_err, de_ref[i])
    ...
    def test_nac_h2_sa3casscf22_631g(self):
        ...
        for i in range(2):
            with self.subTest(use_etfs=bool(i)):
                ...
                self.assertAlmostEqual(de[1], de_ref[i, 1], 5)
                de_err = de - de_ref[i]
                print ("test_nac_h2_sa3casscf22_631g:", de_err, de_ref[i])
    ...
    def test_nac_lih_sa2casscf22_sto3g(self):
        ...
        for i in range(2):
            with self.subTest(use_etfs=bool(i)):
                ...
                self.assertAlmostEqual(de[1], de_ref[i, 1], 5)
                de_err = de - de_ref[i]
                print ("test_nac_lih_sa2casscf22_sto3g:", de_err, de_ref[i])
    ...
    def test_nac_lih_cms3ftlda22_sto3g(self):
        ...
        for i in range(2):
            with self.subTest(use_etfs=bool(i)):
                ...
                self.assertAlmostEqual(de[1], de_ref[i, 1], 5)
                de_err = de - de_ref[i]
                print ("test_nac_lih_sa3casscf22_sto3g:", de_err, de_ref[i])
