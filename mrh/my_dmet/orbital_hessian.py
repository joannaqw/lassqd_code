...
from mrh.util.basis import is_basis_orthonormal
from mrh.util.basis import orthonormalize_a_basis, get_complementary_states
...
class HessianCalculator (object):
    ...
    def _get_Fock2 (self, p, q, r, s, eris):
        ...
        _t0, _w0 = time.process_time (), time.time ()
        for t, a, n in zip (self.twoCDM, self.mo2amo, self.ncas):
            a2q = a.conjugate ().T @ q
            a2s = a.conjugate ().T @ s
